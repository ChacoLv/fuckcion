...
import ccxt
from function.Trade import next_run_time, place_order, get_okex_candle_data, auto_send_email
from function.Signals import signal_moving_average
...
exchange = ccxt.bitfinex()  # 创建交易所，此处为okex交易所
